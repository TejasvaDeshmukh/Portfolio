...
try {
  ...
  if (canvas) {
    ...
    const cyanTexture = createCircleTexture('6, 182, 212'); // #06b6d4
    const purpleTexture = createCircleTexture('168, 85, 247'); // #a855f7
...
if (contactForm) {
  contactForm.addEventListener('submit', (e) => {
    ...
    setTimeout(() => {
      // Create big celebration confetti!
      try {
        confetti({
          particleCount: 150,
          spread: 80,
      ...
      // Update form UI on success
      formStatus.textContent = 'Transmission received successfully! Tejasva will contact you shortly.';
